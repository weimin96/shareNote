...
public class FileUtils {
    ...
    public static String getAppCacheDir() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
            ...
            cachePath = AppController.getAppContext().getExternalCacheDir().getPath();
        } else {
            cachePath = AppController.getAppContext().getCacheDir().getPath();
        }
        return cachePath;
    }
    ...
    public static File[] getAllCacheFile() {
        String packagePath = "/data/data/" + AppController.getAppContext().getPackageName();
        File[] files = new File[5];
        files[0] = AppController.getAppContext().getExternalCacheDir();
