...
/**
 * Created by 你的奥利奥 on 2017/1/27.
 */

public class EditBulletSpan extends BulletSpan {
    ...
    public EditBulletSpan(int bulletColor, int bulletRadius, int bulletGapWidth) {
    ...
    public EditBulletSpan(Parcel src) {
        super(src);
